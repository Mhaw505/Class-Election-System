...
public class ClassRepVoteController {
    ...
    private void loadCandidates() {
        candidateList.clear();
        String sql = "SELECT name FROM candidate WHERE election_type = 'CR'";
    ...
    private void handleVote() {
        ...
        try (Connection conn = DBUtil.getConnection()) {
            ...
            String checkSql = "SELECT * FROM votes WHERE voter_reg_no = ? AND election_type = 'CR'";
            ...
            // 2. Get candidate ID
            int candidateId = -1;
            String candidateSql = "SELECT id FROM candidate WHERE name = ? AND election_type = 'CR'";
            ...
            // 3. Insert vote
            String insertSql = "INSERT INTO votes (candidate_id, voter_reg_no, election_type) VALUES (?, ?, 'CR')";
